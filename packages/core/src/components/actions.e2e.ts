...
test.describe('changebot:action events', () => {
  test('openDisplay, closeDisplay, and toggleDisplay control the panel', async ({ page }) => {
  ...
  test('ignores events for a different scope', async ({ page }) => {
    ...
    const panel = page.locator('changebot-panel .panel');
    expect(await panel.evaluate((el: any) => el.className)).toContain('panel--closed');
  ...
  test('an event without a scope reaches every provider', async ({ page }) => {
  ...
  test('openDisplay marks updates as viewed', async ({ page }) => {
  ...
  test('markViewed clears the badge without opening the panel and persists to localStorage', async ({ page }) => {
  ...
  test('markAllViewed clears the badge and persists to localStorage', async ({ page }) => {
