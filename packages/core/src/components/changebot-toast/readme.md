...
| ----------------------- | ------------------------- | ----------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------- |
| `confetti`              | `confetti`                |             | `boolean`                                                                                                                                                                                                                                                                              | `false`          |
| `confettiParticleCount` | `confetti-particle-count` |             | `number`                                                                                                                                                                                                                                                                               | `351`            |
| `confettiScalar`        | `confetti-scalar`         |             | `number`                                                                                                                                                                                                                                                                               | `0.8`            |
| `confettiSpread`        | `confetti-spread`         |             | `number`                                                                                                                                                                                                                                                                               | `130`            |
| `confettiStartVelocity` | `confetti-start-velocity` |             | `number`                                                                                                                                                                                                                                                                               | `46`             |
...
| `position`              | `position`                |             | `"bottom-left" \| "bottom-right" \| "center" \| "top-left" \| "top-right"`                                                                                                                                                                                                             | `'bottom-right'` |
